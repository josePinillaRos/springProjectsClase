package com.jose.hibernateanotaciones2;
...
import com.jose.hibernateanotaciones2.entidades.Autores;
import com.jose.hibernateanotaciones2.entidades.Libros;
import com.jose.hibernateanotaciones2.utilidades.HibernateUtils;
...
public class App {
	...
	public static void insertarAutoryLibr2o() {		
		Autores autor = new Autores("FRAN", "Francisco García", null);
		Set<Autores> autores = new HashSet<Autores>();
		autores.add(autor);
		Libros libro1 = new Libros(6, "Libro Fran1", autores);
