...
import com.fran.springboot.backend.mvc.usuarios.IUsuariosService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> crear(@Valid @RequestBody Cliente cliente, BindingResult result) {
        ...
        try {
        	...
        	cliente.setCreador(usuarioService.getById(idAuth));
	...
	public ResponseEntity<?> mios(){
		...
		try {
			listaClientes = clienteService.findAll().stream().filter(e->e.getCreador().getId()==idAuth).toList();
